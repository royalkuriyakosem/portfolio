...
const TimelineSection = () => {
    ...
    useGSAP(() => {
        ...
        const pulses = gsap
            ...
            .to(".ball03, .text02, #text-2021 , #uoft", {}, 0.07)
            .to(".ball04, .text03, #text-2024-jul", {}, 0.13)
            .to(".ball05, .text04, #text-2024-sep", {}, 0.17)
    ...
    return (
        <div className='timeline  w-dvw relative pb-40 h-full  '>
            ...
            <svg id="svg-stage" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 2526.3" className='scale-50 2xl:scale-100 origin-left'>
                ...
                <text className="text02" x="50" y="394.11">2021</text>
                <text className="text03" x="50" y="724.11">2024</text>
            ...
            <div id='text-2020' className='timeline-text  absolute top-[26%] left-[42%] md:top-[27%] md:left-[40%] lg:left-[40%] xl:top-[27%] xl:left-[30%] 2xl:top-[7%] 2xl:left-[35%] ' >
                <p>Completed Senior Secondary Education (12th) at St. Joseph's School with 90.80%</p>
            </div>
            <div id='text-2021' className='timeline-text absolute top-[30%] left-[45%] md:top-[31%] md:left-[42%] lg:left-[33%] xl:top-[31%] xl:left-[30%] 2xl:top-[15%] 2xl:left-[37%]'>
                <p>Started Bachelor of Technology in Computer Science at FISAT</p>
            </div>
            <div id='text-2024-jul' className='timeline-text absolute top-[36%] left-[33%] md:top-[38%] md:left-[30%] lg:left-[23%] xl:top-[38%] xl:left-[25%] 2xl:top-[29%] 2xl:left-[22%]'>
                <p>Jul: Android App Development Intern - Developed Lab Entry Log app</p>
            </div>
            ...
            <div id='text-2024-dec' className='timeline-text absolute top-[45%] left-[50%] md:top-[45%] md:left-[46%] lg:left-[35%] lg:top-[45%] xl:top-[45%] xl:left-[32%] 2xl:top-[44%] 2xl:left-[40%]'>
                <p>Dec: Front-End Intern at Nest Digital - Created Indian Tourism Website with Angular</p>
            </div>
